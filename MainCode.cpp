...
int main()
{
    ...
    Paper1<Z_NR<mpz_t>,FP_NR<mpfr_t>>* p1 = new Paper1<Z_NR<mpz_t>,FP_NR<mpfr_t>>("lattices/svpchallengedim44seed0.txt",BKZ_DEFAULT,GSO_DEFAULT,120,FT_DEFAULT);
    ...
    unique_ptr<Z_NR<mpz_t>[]> ans=p1->runGA(1682,10,v0);
    cout<<"runGA complete\n";
